...
display_buf display_formula(formula);
display_buf display_operand(operand);
LinkedList cal_formula;

operand_state state = operand_1;
int entry_flag = 0; //shows there is at least one entry in the calculator
int display_answer_on_formula = 0; //this variable is a flag for when there is new entry after computing a formula, past result will move to the top row first
char read_switch;
